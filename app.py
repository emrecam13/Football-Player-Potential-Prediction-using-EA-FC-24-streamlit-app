...
# ============================
    ...
    st.link_button("Go to :blue[Result Data Basic Statistics]", "https://football-player-potential-prediction-using-ea-fc-24-app.streamlit.app/#result-data-basic-statistics")
